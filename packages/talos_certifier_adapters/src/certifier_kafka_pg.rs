...
use talos_certifier::services::certifier_service_v2::{CertifierServiceConfig, CertifierServiceV2};
...
pub async fn certifier_with_kafka_pg(
    ...
    let certifier_service = Box::new(CertifierServiceV2::new(
    ...
    certifier_service.subscribe().await?;
