...
use crate::{
    callbacks::{oo_installer_single_query::OutOfOrderInstallerImpl, state_provider::StateProviderImpl, statemap_installer::StatemapInstallerImpl},
...
pub struct BankingApp {
    ...
    counter_oo_installs: Arc<Counter<u64>>,
...
impl BankingApp {
    pub async fn new(config: Config) -> Result<Self, String> {
        ...
        let counter_oo_installs = meter.u64_counter("metric_oo_installs").with_unit(Unit::new("tx")).init();
        ...
        Ok(BankingApp {
            ...
            counter_oo_installs: Arc::new(counter_oo_installs),
...
impl Handler<TransferRequest> for BankingApp {
    async fn handle(&self, request: TransferRequest) -> Result<(), String> {
        ...
        let oo_inst = OutOfOrderInstallerImpl {
            ...
            counter_oo_installs: Arc::clone(&self.counter_oo_installs),
